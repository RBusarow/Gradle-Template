...
dependencies {
  ...
  dependencySync("androidx.compose.compiler:compiler:1.0.4")
  dependencySync("androidx.compose.foundation:foundation:1.0.4")
  dependencySync("androidx.compose.material:material-icons-core:1.0.4")
  dependencySync("androidx.compose.material:material-icons-extended:1.0.4")
  dependencySync("androidx.compose.material:material:1.0.4")
  dependencySync("androidx.compose.runtime:runtime:1.0.4")
  dependencySync("androidx.compose.ui:ui-test-junit4:1.0.4")
  dependencySync("androidx.compose.ui:ui-test-manifest:1.0.4")
  ...
  dependencySync("androidx.navigation:navigation-common:2.4.0-beta01")
  dependencySync("androidx.navigation:navigation-compose:2.4.0-beta01")
  dependencySync("androidx.navigation:navigation-fragment-ktx:2.4.0-beta01")
  dependencySync("androidx.navigation:navigation-runtime-ktx:2.4.0-beta01")
  dependencySync("androidx.navigation:navigation-ui-ktx:2.4.0-beta01")
  dependencySync("androidx.paging:paging-common-ktx:3.1.0-beta01")
  dependencySync("androidx.paging:paging-compose:1.0.0-alpha14")
  dependencySync("androidx.paging:paging-runtime-ktx:3.1.0-beta01")
  ...
  dependencySync("com.squareup.anvil:annotations:2.3.7")
