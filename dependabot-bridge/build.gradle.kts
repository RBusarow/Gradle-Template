...
dependencies {
  ...
  dependencySync("androidx.compose.compiler:compiler:1.0.2")
  dependencySync("androidx.compose.foundation:foundation:1.0.2")
  dependencySync("androidx.compose.material:material-icons-core:1.0.2")
  dependencySync("androidx.compose.material:material-icons-extended:1.0.2")
  dependencySync("androidx.compose.material:material:1.0.2")
  dependencySync("androidx.compose.runtime:runtime:1.0.2")
  dependencySync("androidx.compose.ui:ui-test-junit4:1.0.2")
  ...
  dependencySync("androidx.lifecycle:lifecycle-viewmodel-savedstate:2.3.0")
  dependencySync("androidx.lifecycle:lifecycle-viewmodel:2.3.0")
  dependencySync("androidx.navigation:navigation-common:2.4.0-alpha09")
  dependencySync("androidx.navigation:navigation-compose:2.4.0-alpha09")
  dependencySync("androidx.navigation:navigation-fragment-ktx:2.4.0-alpha09")
  dependencySync("androidx.navigation:navigation-runtime-ktx:2.4.0-alpha09")
  dependencySync("androidx.navigation:navigation-ui-ktx:2.4.0-alpha09")
  ...
  dependencySync("androidx.room:room-paging:2.4.0-alpha04")
  ...
  dependencySync("com.github.tschuchortdev:kotlin-compile-testing:1.4.4")
  ...
  dependencySync("org.junit.jupiter:junit-jupiter:5.8.0")
  dependencySync("org.junit.vintage:junit-vintage-engine:5.8.0")
