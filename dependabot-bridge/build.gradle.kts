...
dependencies {
  ...
  dependencySync("androidx.compose.material:material-icons-core:1.0.5")
  dependencySync("androidx.compose.material:material-icons-extended:1.0.5")
  dependencySync("androidx.compose.material:material:1.0.5")
  dependencySync("androidx.compose.runtime:runtime:1.0.5")
  dependencySync("androidx.compose.ui:ui-test-junit4:1.0.5")
  dependencySync("androidx.compose.ui:ui-test-manifest:1.0.5")
  dependencySync("androidx.compose.ui:ui-tooling:1.0.5")
  dependencySync("androidx.compose.ui:ui:1.0.5")
  ...
  dependencySync("androidx.fragment:fragment-testing:1.4.0")
  dependencySync("androidx.fragment:fragment:1.4.0")
  ...
  dependencySync("androidx.navigation:navigation-common:2.4.0-beta02")
  dependencySync("androidx.navigation:navigation-compose:2.4.0-beta02")
  dependencySync("androidx.navigation:navigation-fragment-ktx:2.4.0-beta02")
  dependencySync("androidx.navigation:navigation-runtime-ktx:2.4.0-beta02")
  dependencySync("androidx.navigation:navigation-ui-ktx:2.4.0-beta02")
  ...
  dependencySync("androidx.room:room-common:2.4.0-beta02")
  dependencySync("androidx.room:room-compiler:2.4.0-beta02")
  dependencySync("androidx.room:room-ktx:2.4.0-beta02")
  dependencySync("androidx.room:room-paging:2.4.0-beta02")
  dependencySync("androidx.room:room-runtime:2.4.0-beta02")
  dependencySync("androidx.room:room-testing:2.4.0-beta02")
  ...
  dependencySync("com.google.dagger:dagger:2.40.2")
  dependencySync("com.google.devtools.ksp:symbol-processing-gradle-plugin:1.6.0-1.0.1")
  ...
  dependencySync("com.squareup.anvil:annotations:2.3.10-1-6-0")
  dependencySync("com.squareup.anvil:compiler-api:2.3.10-1-6-0")
  dependencySync("com.squareup.anvil:compiler-utils:2.3.10-1-6-0")
  dependencySync("com.squareup.anvil:compiler:2.3.10-1-6-0")
  ...
  dependencySync("io.kotest:kotest-assertions-shared-jvm:5.0.0")
  dependencySync("io.kotest:kotest-common-jvm:5.0.0")
  dependencySync("io.kotest:kotest-property-jvm:5.0.0")
  dependencySync("io.kotest:kotest-runner-junit5-jvm:5.0.0")
  dependencySync("io.mockk:mockk:1.12.1")
